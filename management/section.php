...
/**
 * Catalogue section management page.
 *
...
$currenturl = new url('/admin/tool/mucatalog/management/section.php', ['id' => $section->id]);
...
echo $managementoutput->render_section_general($section);
