...
/**
 * Add a new catalogue collection.
 *
...
$currenturl = new url('/admin/tool/mucatalog/management/collection_create.php', ['contextid' => $context->id]);
$returnurl = new url('/admin/tool/mucatalog/management/collections.php');
