...
$collection->cohortids = array_keys(collection::get_cohortvisible_menu($collection->id));

$form = new \tool_mucatalog\local\form\collection_delete(null, ['currentdata' => $collection, 'context' => $context]);
