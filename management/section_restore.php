...
$currenturl = new url('/admin/tool/mucatalog/management/section_restore.php', ['id' => $section->id]);
...
$form = new \tool_mucatalog\local\form\section_restore(null, ['currentdata' => $section, 'context' => $context]);
